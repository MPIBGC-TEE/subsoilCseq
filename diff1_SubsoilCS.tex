...
%DIF DEL subsoilCS.tex      Fri Jun  2 13:49:05 2023
%DIF ADD subsoilCS_R1.tex   Fri Nov  3 17:12:26 2023
...
%DIF 24-25c24-25
%DIF < \author[2]{Martin Bolinder \orcidlink{0000-0002-3574-3061}}
%DIF < \author{Maarten C. Braakhekke}
%DIF -------
\author[2]{Martin A. Bolinder \orcidlink{0000-0002-3574-3061}} %DIF > 
\author{Maarten C. Braakhekke \orcidlink{0000-0002-1889-2225}} %DIF > 
%DIF -------
...
%DIF 36c36
%DIF < \affil[5]{Beijing Normal University, Beijing, China}
%DIF -------
\affil[5]{Faculty of Geographical Science, Beijing Normal University, Beijing, China} %, 100875} %DIF > 
%DIF -------
...
\linenumbers
\begin{abstract} \noindent
Soils store large quantities of carbon in the subsoil (below 0.2 m depth) that is generally old and believed to be stabilized over centuries to millennia, which suggests that subsoil carbon sequestration can be used as a strategy for climate change mitigation. In this article, we review the main biophysical processes that contribute to carbon  storage in subsoil and the main mathematical models used to represent these processes. Our guiding objective is to review whether a process understanding of soil carbon movement in the vertical profile can help us to assess carbon \DIFdelbegin \DIFdel{sequestration potential }\DIFdelend \DIFaddbegin \DIFadd{storage and persistence }\DIFaddend at timescales relevant for climate change mitigation. 
Bioturbation, liquid phase transport, belowground carbon inputs, mineral association, and microbial activity, are the main processes contributing to the formation of soil carbon profiles, and these processes are represented in models using the \DIFdelbegin \DIFdel{advection-diffusion-reaction }\DIFdelend \DIFaddbegin \DIFadd{diffusion-advection-reaction }\DIFaddend paradigm. 
...
Using the transit time of carbon to assess the timescales of carbon storage of new inputs, we show that only small quantities of new carbon inputs travel through the \DIFdelbegin \DIFdel{depth }\DIFdelend profile and can be stabilized for time horizons longer than 50 years, implying that activities that promote carbon sequestration in the subsoil must take into consideration the very small quantities that can be stabilized in the long term. 
%DIF < Therefore, promoting conservation of deep soil carbon may be more relevant for near-term climate change mitigation than promoting new carbon inputs to subsoil. 
\DIFaddbegin \DIFadd{Land management activities could increase C storage in the subsoil by increasing advective vertical transport and decreasing the difference between inputs and decomposition at all depths. 
}\DIFaddend \end{abstract}

\vspace{1cm}
\noindent
\textbf{Keywords}: Climate change mitigation, soil carbon sequestration, transit time, \DIFdelbegin \DIFdel{advection-diffusion-reaction} \DIFdelend \DIFaddbegin \DIFadd{diffusion-advection-reaction}\DIFaddend , microbial decomposition, organic matter stabilization, radiocarbon
...
}\DIFdelend %DIF > We focus on most natural processes, but we do not consider the vertical redistribution of C along the profile through tillage or other human interferences, which can cause a sudden change in SOC distribution that may have impact on C dynamics.
...
\DIFdelbegin \DIFdel{The accumulation of organic carbon in the vertical profile is an important part of soil formation \mbox{%DIFAUXCMD
\citep{Jenny1980, vanBreemen1997}}\hskip0pt%DIFAUXCMD
, taking place on timescales of
decades to millennia. Overall, soil carbon dynamics is determined by the gain and loss (above and belowground) of carbon inputs, and decomposition. When studying the vertical distribution }\DIFdelend \DIFaddbegin \DIFadd{A number of physical, chemical, and biological processes contribute to the formation }\DIFaddend of soil carbon \DIFdelbegin \DIFdel{, the depth dependence }\DIFdelend \DIFaddbegin \DIFadd{profiles, which have been reviewed with some detail elsewhere \mbox{%DIFAUXCMD
\citep[e.g.][]{Button2022,HicksPries2023}}\hskip0pt%DIFAUXCMD
. Here, we briefly review some }\DIFaddend of these processes \DIFdelbegin \DIFdel{is relevant, as
well as vertical transport, erosion and deposition. Vertical organic matter transport can have a major effect on the soil carbon profile and is generally caused by mixing processes and transport of mobile fractions with the liquid
phase \mbox{%DIFAUXCMD
\citep{vanBreemen1997, Rumpel2011}}\hskip0pt%DIFAUXCMD
. In terrestrial soils, mixing of the soil —}\DIFdelend \DIFaddbegin \DIFadd{grouping them according to their most common representation in models. Our objetive is to make a parallel between process understanding and mathematical representations in models, which are reviewed in section \ref{sec:models}.
}

%DIF > The accumulation of organic carbon in the vertical profile is an important part of soil formation \citep{Jenny1980, vanBreemen1997, HicksPries2023}, taking place on timescales of
%DIF > decades to millennia. Overall, soil carbon dynamics is determined by the gain and loss (above and belowground) of carbon inputs, and decomposition. When studying the
%DIF > vertical distribution of soil carbon, the depth dependence of these processes is relevant, as
%DIF > well as vertical transport, erosion and deposition.
%DIF > Vertical organic matter transport can have a major effect on the soil carbon profile and is generally caused by mixing processes and transport of mobile fractions with the liquid
%DIF > phase \citep{vanBreemen1997, Rumpel2011}. In terrestrial soils, mixing of the soil—referred to as “pedoturbation” \citep{Hole1961}—can
%DIF > occur by several processes, including the reworking activity of soil fauna (bioturbation), freezing and thawing (cryoturbation) \citep{Johnson1987} and human disturbance such as tillage. Cryoturbation
%DIF > occurs mainly in permafrost affected soils, which cover large regions at high latitudes. 
%DIF > %Since these ecosystems are unfavorable to soil fauna, this process forms a
%DIF > %relatively large contribution to organic matter redistribution in high-latitude soils (Bockheim, 2007). 
%DIF > In other systems however, bioturbation and liquid phase transport are the main transport processes that redistribute carbon vertically. 

%DIF > In layers with high organic matter concentrations, an important additional transport flux occurs that is generally ignored in soil carbon profile models. Loss of mass due
%DIF > to decomposition leads to downward shift of material above, while surface litter deposition continually buries older material. This mass-loss causes advective downward or upward flow
%DIF > of material unrelated to mixing or water movement \citep{Ahrens2015}. \citep{Kaste2007} found this
%DIF > process to be relevant for the vertical distribution of 210Pbex in the organic surface
%DIF > horizon of a podzol, and \citet{Hilbert2000} for modelling subsidence of peat soils. 
%DIF > This may be simulated by tracking “cohorts”: layers of litter
%DIF > that are deposited within specific time intervals, and thus have similar age. Such
%DIF > models have been applied to simulate peat accumulation (Heinemeyer et al., 2010).

\subsection{\DIFadd{Pedoturbation as diffusive vertical movement}}
\DIFadd{Processes that mix the soil are commonly }\DIFaddend referred to as \DIFdelbegin \DIFdel{“pedoturbation ” \mbox{%DIFAUXCMD
\citep{Hole1961}}\hskip0pt%DIFAUXCMD
—can
occur by several processes, including }\DIFdelend \DIFaddbegin \DIFadd{pedoturbation \mbox{%DIFAUXCMD
\citep{Hole1961, Martin2017}}\hskip0pt%DIFAUXCMD
, which include }\DIFaddend the reworking activity of soil fauna (bioturbation), freezing and thawing \DIFaddbegin \DIFadd{cycles }\DIFaddend (cryoturbation) \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Johnson1987} }\hskip0pt%DIFAUXCMD
and human disturbance }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Johnson1987, Bockheim2007, Beer2022}}\hskip0pt%DIFAUXCMD
,  uprooting of trees \mbox{%DIFAUXCMD
\citep{Schaetzl1990}}\hskip0pt%DIFAUXCMD
, swelling and translocation of clays \mbox{%DIFAUXCMD
\citep{Finke2012}}\hskip0pt%DIFAUXCMD
, and human disturbances }\DIFaddend such as tillage \DIFdelbegin \DIFdel{. Cryoturbation
occurs mainly in permafrost affected soils, which cover large regions at high latitudes. 
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Martin2017, Keyvanshokouhi2019}}\hskip0pt%DIFAUXCMD
. Bioturbation and tillage are the pedoturbation processes most commonly considered in models of soil carbon profiles, mostly represented in analogy to particle diffusion. 
%DIF > Cryoturbation
%DIF > occurs mainly in permafrost affected soils, a process that contributes to the vertical redistribution of organic matter at high latitudes \citep{Bockheim2007}. 
}\DIFaddend %Since these ecosystems are unfavorable to soil fauna, this process forms a
%relatively large contribution to organic matter redistribution in high-latitude soils (Bockheim, 2007). 
\DIFdelbegin \DIFdel{In other systems however, bioturbation and liquid phase transport are the main transport processes that redistribute carbon vertically. 
}\DIFdelend 
...
of material unrelated to mixing or water movement \mbox{%DIFAUXCMD
\citep{Ahrens2015}}\hskip0pt%DIFAUXCMD
. \mbox{%DIFAUXCMD
\citep{Kaste2007} }\hskip0pt%DIFAUXCMD
found this
process to be relevant for the vertical distribution of 210Pbex in the organic surface
horizon of a podzol, and \mbox{%DIFAUXCMD
\citet{Hilbert2000} }\hskip0pt%DIFAUXCMD
...
\DIFdel{Bioturbation is defined as the biological reworking of soils and sediments by different kinds of organisms, including plant rooting systems, and most importantly, burrowing animals \mbox{%DIFAUXCMD
\citep{Meysman2006}}\hskip0pt%DIFAUXCMD
. \mbox{%DIFAUXCMD
\citet{Chapin2002} }\hskip0pt%DIFAUXCMD
...
engineers” \mbox{%DIFAUXCMD
\citep{Meysman2006}}\hskip0pt%DIFAUXCMD
.
The rate of soil displacement by bioturbating organisms is usually estimated by
measuring deposition of mounds at the soil surface. \mbox{%DIFAUXCMD
\citet{Paton1995} }\hskip0pt%DIFAUXCMD
reviewed
...
}\DIFdelend %DIF > Bioturbation is defined as the biological reworking of soils and sediments by different kinds of organisms, including plant rooting systems, and most importantly, burrowing animals \citep{Meysman2006}. 
%DIF > \citet{Chapin2002} noted that in temperate
%DIF > regions the mixing activity of earthworms represents a force that is orders of magnitude
%DIF > larger than other geomorphic processes such as erosion. The potential effects of
%DIF > bioturbators on their habitat are so severe that they have been called “ecosystem
%DIF > engineers” \citep{Meysman2006}.
%DIF > The rate of soil displacement by bioturbating organisms is usually estimated by
%DIF > measuring deposition of mounds at the soil surface. 
%DIF > \citet{Paton1995} reviewed a range of quantitative estimates for different organisms and concluded that the
%DIF > most important animal groups contributing to bioturbation are earthworms, ants, mammals, and termites, with rates
%DIF > of mounding that can range from 0.0063 to 27 kg m$^{-2}$ yr$^{-1}$ . 
...
\DIFdelbegin \DIFdel{However, at small spatial scales the effects of bioturbation are
...
more likely to affect (fresh) litter rather  than mineral fractions \mbox{%DIFAUXCMD
\citep{Johnson2005}}\hskip0pt%DIFAUXCMD
. The
...
surface for incorporation into their surface mounds \mbox{%DIFAUXCMD
\citep{Paton1995}}\hskip0pt%DIFAUXCMD
. (iii) The
distance of particle translocation may be in some cases quite large compared to the scale of a single
soil profile \mbox{%DIFAUXCMD
\citep{Boudreau1986b}}\hskip0pt%DIFAUXCMD
.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{Although the relevance of bioturbation for organic matter redistribution is well
recognized \mbox{%DIFAUXCMD
\citep{vanBreemen1997, Chapin2002, Hoosbeek2009}}\hskip0pt%DIFAUXCMD
, very few empirical studies have been performed on its effects on
the shape of the soil C profile \mbox{%DIFAUXCMD
\citep{Tonneijck2008, Yoo2011}}\hskip0pt%DIFAUXCMD
, particularly on
long timescales. Based on micromorphological analysis and radiocarbon measurements,
\mbox{%DIFAUXCMD
\citet{Tonneijck2008} }\hskip0pt%DIFAUXCMD
showed that bioturbation was the main mechanism
for carbon input at depthin a volcanic ash soil, more important than liquid phase
transport and root input. On shorter time scales, studies of earthworm invasions
in forests have demonstrated dramatic effects on organic surface layers \mbox{%DIFAUXCMD
\citep{Alban1994, Bohlen2004}}\hskip0pt%DIFAUXCMD
. For example, \mbox{%DIFAUXCMD
\citet{Alban1994} }\hskip0pt%DIFAUXCMD
found that
increasing earthworm populations in a temperate podzol led to a reduction of forest
floor mass by 85 \% and disappearance of the eluviation horizon in 14 years}\DIFdelend \DIFaddbegin \DIFadd{In croplands, tillage contributes to vertical mixing of soil carbon, altering the depth distribution of root inputs and crop residues \mbox{%DIFAUXCMD
\citep{Luo2010}}\hskip0pt%DIFAUXCMD
. Depending on ploughing depth, the effects of tillage may only concentrate on the topsoil and may be difficult to observe at depths below 40 cm \mbox{%DIFAUXCMD
\citep{Luo2010,Keyvanshokouhi2019, Mary2020}}\hskip0pt%DIFAUXCMD
. Due to this mixing effect, both bioturbation and tillage are commonly represented in models as a process of particle diffusion}\DIFaddend . 

%DIF > However, at small spatial scales the effects of bioturbation are
%DIF > more complex, for several reasons: (i) Certain fractions may be transported preferentially. For example, since mixing by earthworms is mostly related to feeding, it is
%DIF > more likely to affect (fresh) litter rather  than mineral fractions \citep{Johnson2005}. The
%DIF > coarsest fractions, including stones, may be completely unaffected by bioturbation.
%DIF > (ii) Mixing may occur more strongly in one direction than in others (anisotropic mixing). For example termites bring clay particles from considerable depths to the soil
%DIF > surface for incorporation into their surface mounds \citep{Paton1995}. (iii) The
%DIF > distance of particle translocation may be in some cases quite large compared to the scale of a single
%DIF > soil profile \citep{Boudreau1986b}.
\DIFaddbegin 

%DIF > Although the relevance of bioturbation for organic matter redistribution is well
%DIF > recognized \citep{vanBreemen1997, Chapin2002, Hoosbeek2009}, very few empirical studies have been performed on its effects on
%DIF > the shape of the soil C profile \citep{Tonneijck2008, Yoo2011}, particularly on
%DIF > long timescales. Based on micromorphological analysis and radiocarbon measurements,
%DIF > \citet{Tonneijck2008} showed that bioturbation was the main mechanism
%DIF > for carbon input at depth in a volcanic ash soil, more important than liquid phase
%DIF > transport and root input. On shorter time scales, studies of earthworm invasions
%DIF > in forests have demonstrated dramatic effects on organic surface layers \citep{Alban1994, Bohlen2004}. For example, \citet{Alban1994} found that
%DIF > increasing earthworm populations in a temperate podzol led to a reduction of forest
%DIF > floor mass by 85 \% and disappearance of the eluviation horizon in 14 years.

\DIFaddend \subsection{\DIFdelbegin \DIFdel{Liquid phase }\DIFdelend \DIFaddbegin \DIFadd{Advective }\DIFaddend transport \DIFaddbegin \DIFadd{in liquid phase}\DIFaddend }
...
be important terms in shaping the dynamics of soil carbon at depth \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Kalbitz2008, Kindler2011, Kaiser2012}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Neff2001, Kalbitz2008, Kindler2011, Kaiser2012}}\hskip0pt%DIFAUXCMD
}\DIFaddend . DOC is highly relevant for the formation of the soil profile since it is subject to potentially very fast transport with downward water fluxes and represents a
...
\DIFdelbegin \DIFdel{DOC is not chemically well defined, but consists of a broad spectrum of organic substances ranging from small molecules to complex humic acids
\mbox{%DIFAUXCMD
\citep{Kalbitz2000, Michalzik2001}}\hskip0pt%DIFAUXCMD
. The biodegradability of these substances
ranges over several orders of magnitude \mbox{%DIFAUXCMD
\citep{Kalbitz2000}}\hskip0pt%DIFAUXCMD
, with more resistant
compounds generally increasing with depth \mbox{%DIFAUXCMD
\citep{Kalbitz2000, Sanderman2008}}\hskip0pt%DIFAUXCMD
.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{DOC may originate from several sources, with their relative contribution being highly variable for different ecosystems
\mbox{%DIFAUXCMD
\citep{Kalbitz2000, Chantigny2003}}\hskip0pt%DIFAUXCMD
. Leaching of fresh litter contributes strongly to
...
DOC in the mineral soil \mbox{%DIFAUXCMD
\citep{Neff2001}}\hskip0pt%DIFAUXCMD
. More complex and recalcitrant
dissolved organic substances may be formed predominantly as a byproduct of decomposition, contributing more to }\DIFdelend \DIFaddbegin 

\DIFadd{The concentration of }\DIFaddend DOC \DIFdelbegin \DIFdel{in the mineral soil}\DIFdelend \DIFaddbegin \DIFadd{in soils covaries with precipitation \mbox{%DIFAUXCMD
\citep{Liu2021} }\hskip0pt%DIFAUXCMD
as water acts as the main medium for DOC transport. Therefore, rates of vertical water movement are commonly used to estimate DOC vertical transfer as an advective process \mbox{%DIFAUXCMD
\citep{Ota2013}}\hskip0pt%DIFAUXCMD
}\DIFaddend . 

\DIFdelbegin \DIFdel{DOC also enters the soil by
throughfall \mbox{%DIFAUXCMD
\citep{Michalzik2001}}\hskip0pt%DIFAUXCMD
, and root exudation \mbox{%DIFAUXCMD
\citep{Neff2001}}\hskip0pt%DIFAUXCMD
, 
and it is removed from the soil solution by uptake and decomposition by microbes. 
}\DIFdelend A considerable part of DOC is easily degradable, with low molecular weigh compounds decreasing strongly with depth \citep{Roth2019}.  \DIFdelbegin \DIFdel{Another }\DIFdelend \DIFaddbegin \DIFadd{An }\DIFaddend important mechanism for DOC removal
...
matter \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Neff2001}}\hskip0pt%DIFAUXCMD
.
These interactions are highly variable and depend
on the chemical properties of DOC, the sorbent, and the soil solution. 
Furthermore,
in acid soils DOC may (co-)precipitate with Al and Fe ions, which is an important process for the formation of the illuviation horizon in podzols \mbox{%DIFAUXCMD
\citep{vanBreemen1997}}\hskip0pt%DIFAUXCMD
. As a result of these interactions, the apparent vertical transport of DOC is significantly lower than that of water, and DOC concentrations are often much lower in the deep soil than near the surface
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Neff2001, Kalbitz2008}}\hskip0pt%DIFAUXCMD
.
}

\DIFadd{One important characteristic of representing liquid phase transport as an advective process is that carbon is moved to parts of the profile where decomposition is slow, preventing fast losses due to microbial activity. 
}

\DIFadd{In layers with high organic matter concentrations, an important additional transport flux occurs that is generally ignored in soil carbon profile models. Loss of mass due
to decomposition leads to downward shift of material above, while surface litter deposition continually buries older material. This mass-loss causes advective downward or upward flow
of material unrelated to mixing or water movement \mbox{%DIFAUXCMD
\citep{Ahrens2015}}\hskip0pt%DIFAUXCMD
. \mbox{%DIFAUXCMD
...
horizon of a podzol, and \mbox{%DIFAUXCMD
\citet{Hilbert2000} }\hskip0pt%DIFAUXCMD
for modelling subsidence of peat soils}\DIFaddend . 

%DIF > DOC is not chemically well defined, but consists of a broad spectrum of organic substances ranging from small molecules to complex humic acids
%DIF > \citep{Kalbitz2000, Michalzik2001}. The biodegradability of these substances
%DIF > ranges over several orders of magnitude \citep{Kalbitz2000}, with more resistant
%DIF > compounds generally increasing with depth \citep{Kalbitz2000, Sanderman2008}.
\DIFaddbegin 

%DIF > DOC may originate from several sources, with their relative contribution being highly variable for different ecosystems
%DIF > \citep{Kalbitz2000, Chantigny2003}. Leaching of fresh litter contributes strongly to
%DIF > DOC production in the surface organic layer. However, for most plant
%DIF > species litter leachate is relatively labile, and thus may not contribute strongly to
%DIF > DOC in the mineral soil \citep{Neff2001}. More complex and recalcitrant
%DIF > dissolved organic substances may be formed predominantly as a byproduct of decomposition, 
%DIF > contributing more to DOC in the mineral soil. 

%DIF > DOC also enters the soil by
%DIF > throughfall \citep{Michalzik2001}, and root exudation \citep{Neff2001}, 
%DIF > and it is removed from the soil solution by uptake and decomposition by microbes. 
%DIF > A considerable part of DOC is easily degradable, with low molecular weigh compounds decreasing strongly
%DIF > with depth \citep{Roth2019}. Another important mechanism for DOC removal
%DIF > is immobilization due to interactions with the solid phase and (co-)precipitation.
%DIF > Through a range of chemical mechanisms, DOC is adsorbed to surfaces of minerals (particularly Al and Fe hydroxides and clay) and to a lesser extent to solid organic
%DIF > matter \citep{Neff2001}. These interactions are highly variable and depend
%DIF > on the chemical properties of DOC, the sorbent, and the soil solution. 
%DIF > Furthermore,
%DIF > in acid soils DOC may (co-)precipitate with Al and Fe ions, which is an important
%DIF > process for the formation of the illuviation horizon in podzols \citep{vanBreemen1997}. As a result of these interactions, the apparent vertical transport of DOC is significantly lower than that of water, and DOC concentrations are often much lower in
%DIF > the deep soil than near the surface. 

\DIFaddend %Furthermore, the fact that certain compounds are
...
\DIFdelbegin \DIFdel{Total litter input to soil can be divided into an aboveground fraction: leaves/needles, stems, branches,
...
\mbox{%DIFAUXCMD
\citep{Nguyen2009}}\hskip0pt%DIFAUXCMD
. }\DIFdelend %DIF > Total litter input to soil can be divided into an aboveground fraction: leaves/needles, stems, branches,
%DIF > and fruits; and a belowground fraction, also referred to as rhizodeposition: root
%DIF > mortality, sloughing off of root tissue, and secretion of mucilage and root exudates
%DIF > \citep{Nguyen2009}. 
The relative distribution of \DIFdelbegin \DIFdel{the litter input over these two }\DIFdelend \DIFaddbegin \DIFadd{litter input between above- and belowground }\DIFaddend fractions,
as well as the vertical distribution of the belowground input\DIFaddbegin \DIFadd{, }\DIFaddend is highly relevant for the
...
Since net primary production (NPP) is the source of litter input, its \DIFdelbegin \DIFdel{distribution over }\DIFdelend \DIFaddbegin \DIFadd{partition between }\DIFaddend above- and below-ground biomass is a good predictor of the relative proportions of aboveground litter
fall and rhizodeposition \citep{Raich1989, Xiao2023}. 
\DIFdelbegin \DIFdel{For instance, herbaceous vegetation types
and shrubs allocate the highest fraction of NPP belowground, and forests the lowest fraction \mbox{%DIFAUXCMD
\citep{Chapin2002}}\hskip0pt%DIFAUXCMD
. \mbox{%DIFAUXCMD
\citet{Saugier2001} }\hskip0pt%DIFAUXCMD
compiled NPP estimates and
...
The proportion for common annual agricultural crops and perennial forages represents about 20 \% and 50 \%, respectively \mbox{%DIFAUXCMD
\citep{Bolinder2007}}\hskip0pt%DIFAUXCMD
.
Root to shoot biomass ratios follow a similar pattern \mbox{%DIFAUXCMD
\citep{Jackson1996}}\hskip0pt%DIFAUXCMD
. Due to the difficulty of measuring NPP, particularly belowground,
these figures should be considered carefully \mbox{%DIFAUXCMD
\citep{Clark2001}}\hskip0pt%DIFAUXCMD
. 
}\DIFdelend %DIF > For instance, herbaceous vegetation types
%DIF > and shrubs allocate the highest fraction of NPP belowground, and forests the lowest fraction \citep{Chapin2002}. \citet{Saugier2001} compiled NPP estimates and
%DIF > concluded that on average 67 \% and 57 \% of NPP is allocated belowground for grasslands and arctic tundra, respectively, whereas for temperate and boreal forests this
%DIF > fraction is 39 \% and 44 \%. 
%DIF > The proportion for common annual agricultural crops and perennial forages represents about 20 \% and 50 \%, respectively \citep{Bolinder2007}.
%DIF > Root to shoot biomass ratios follow a similar pattern \citep{Jackson1996}. Due to the difficulty of measuring NPP, particularly belowground,
%DIF > these figures should be considered carefully \citep{Clark2001}. 
\DIFaddbegin 

\DIFaddend Synthesizing global data sets including NPP measurements from 725 soil profiles, root biomass and its depth distribution from 559 soil profiles, \citet{Xiao2023} recently mapped depth-resolved belowground NPP (BNPP) at 1 km resolution across the globe. They found that global average BNPP allocated to the 0–20 cm soil layer is estimated to be 1.1 Mg C ha$^{-1}$ yr$^{-1}$, accounting for $\sim$60\% of total BNPP. Across the globe, the depth distribution of BNPP varies largely \DIFaddbegin \DIFadd{but mostly follows a decreasing trend with depth}\DIFaddend , and more BNPP is allocated to deeper layers in hotter and drier regions. 
\DIFdelbegin \DIFdel{Edaphic, climatic and topographic properties (in order of importance) explain $>80$\% of such variability; and the direction and magnitude of the influence of individual properties are soil depth- and biome-dependent \mbox{%DIFAUXCMD
\citep{Xiao2023}}\hskip0pt%DIFAUXCMD
. 
Furthermore,
plants may change their allocation pattern and rooting profile when changes in nutrient and water availability and other environmental factors occur \mbox{%DIFAUXCMD
\citep{Jackson2000}}\hskip0pt%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \DIFadd{The highest levels of BNPP and carbon inputs to subsoil are in tropical and subtropical latitudes as well as in temperate forests and grasslands, while lowest levels of BNPP are in desserts and high latitude regions \mbox{%DIFAUXCMD
\citep{Xiao2023}}\hskip0pt%DIFAUXCMD
. 
%DIF > Edaphic, climatic and topographic properties (in order of importance) explain $>80$\% of such variability; and the direction and magnitude of the influence of individual properties are soil depth- and biome-dependent \citep{Xiao2023}. 
%DIF > Furthermore,
%DIF > plants may change their allocation pattern and rooting profile when changes in nutrient and water availability and other environmental factors occur \citep{Jackson2000}.
}\DIFaddend 
...
of substances such as lignin, cutin, and suberin \mbox{%DIFAUXCMD
\citep{Rasse2005}}\hskip0pt%DIFAUXCMD
. Furthermore,
since root input occurs predominantly in the mineral soil, it is subject to stabilization
mechanisms related to the mineral phase such as adsorption and occlusion in aggregates \mbox{%DIFAUXCMD
\citep{Rasse2005}}\hskip0pt%DIFAUXCMD
. 
}\DIFdelend %DIF > Decomposition dynamics of above and belowground litter differ substantially
%DIF > due to differences in chemical composition and environmental factors at the deposition site—at the surface or directly within the profile. Root litter has repeatedly been
%DIF > found to be more chemically complex than aboveground litter due to the presence
%DIF > of substances such as lignin, cutin, and suberin \citep{Rasse2005}. Furthermore,
%DIF > since root input occurs predominantly in the mineral soil, it is subject to stabilization
%DIF > mechanisms related to the mineral phase such as adsorption and occlusion in aggregates \citep{Rasse2005}. 
...
surface layers. \mbox{%DIFAUXCMD
\citet{Jackson2000} }\hskip0pt%DIFAUXCMD
...
rooting profiles with only 50 \% of the roots in the top 30 cm}\DIFdelend %DIF > Rhizodeposition is vertically distributed over the mineral soil profile and organic
%DIF > surface layers. 
%DIF > \citet{Jackson2000} analysed a global data set of root distribution
%DIF > measurements and found that tundra, boreal forests and temperate grasslands generally have the shallowest profiles with 80–90 \% of the roots occurring at the top 30 cm
%DIF > of the soil. Deserts and temperate coniferous forests had the deepest
%DIF > rooting profiles with only 50 \% of the roots in the top 30 cm. 
\DIFaddbegin 

\DIFadd{In croplands, the belowground distribution of root inputs is associated with crop type and whether annual or perennial cropping systems are in place \mbox{%DIFAUXCMD
\citep{Mosier2021, HicksPries2023}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
In a review for temperate agricultural crops, \citet{Fan2016} showed that 50\% of the roots \DIFdelbegin \DIFdel{were accumulating }\DIFdelend \DIFaddbegin \DIFadd{mostly accumulate }\DIFaddend in the upper 8 -- 20 cm\DIFdelbegin \DIFdel{.
}\DIFdelend \DIFaddbegin \DIFadd{, and \mbox{%DIFAUXCMD
\citet{Bolinder2007} }\hskip0pt%DIFAUXCMD
found that the proportion of total NPP allocated belowground for common agricultural crops and perennial forages represents about 20\% and 50\%, respectively.
}

\DIFaddend Independent of vegetation \DIFaddbegin \DIFadd{or crop }\DIFaddend type, root distribution seems to be mostly determined by soil hydrology, as
...
\DIFdelbegin \DIFdel{Although rhizodeposition and root biomass are strongly related, they may not
...
play a greater role in water and nutrient uptake \mbox{%DIFAUXCMD
\citep{Anderson2003}}\hskip0pt%DIFAUXCMD
. Hence, it
...
radiocarbon analysis shows that also within the fine root fraction, production and mortality rates decrease with depth \mbox{%DIFAUXCMD
\citep{Gaudinski2010}}\hskip0pt%DIFAUXCMD
.
In a study with pulse-labelled $^{13}$C-CO$_2$, \mbox{%DIFAUXCMD
\citet{Hirte2018} }\hskip0pt%DIFAUXCMD
found that the proportion of rhizodeposition C of belowground inputs increased with soil depth for maize and wheat. Thus, rhizodeposition remains to be one of the most difficult C input sources to quantify, with a wide range of estimates that also depends on plant species/cultivars and growth stages \mbox{%DIFAUXCMD
\citep[e.g.][]{Amos2006, Pausch2018}}\hskip0pt%DIFAUXCMD
.
}\DIFdelend 

\DIFdelbegin \subsection{\DIFdel{Depth dependence of soil organic matter properties and dynamics}}
%DIFAUXCMD
\addtocounter{subsection}{-1}%DIFAUXCMD
\DIFdel{The chemical properties of soils change along the vertical profile \mbox{%DIFAUXCMD
\citep{Rumpel2011, Vancampenhout2012}}\hskip0pt%DIFAUXCMD
. Most well-known are the decrease of
C/N ratio with depth, and the enrichment of $^{13}$C and $^{15}$N \mbox{%DIFAUXCMD
\citep{Ehleringer2000, Nadelhoffer1988, Hogberg1997, Paul2020}}\hskip0pt%DIFAUXCMD
. These gradients indicate a change from plant derived
to more decomposed and microbial derived organic matter with depth \mbox{%DIFAUXCMD
\citep{Rumpel2002, Rumpel2011, Baisden2002}}\hskip0pt%DIFAUXCMD
. It has been suggested that microbial residues are more effectively stabilized by organo-mineral interactions, which have been found to be an important mechanism in the deep soil
\mbox{%DIFAUXCMD
\citep{Rumpel2012}}\hskip0pt%DIFAUXCMD
.
}\DIFdelend %DIF > Although rhizodeposition and root biomass are strongly related, they may not
%DIF > have exactly the same vertical distribution, since not all roots contribute equally to rhizodeposition. Fine roots have higher mortality rates and excrete more exudates since they
%DIF > play a greater role in water and nutrient uptake \citep{Anderson2003}. Hence, it
%DIF > is likely that organic matter input by roots is more closely related to the fine root
%DIF > profile, which is more shallow than the overall distribution of roots. Furthermore,
%DIF > radiocarbon analysis shows that also within the fine root fraction, production and mortality rates decrease with depth \citep{Gaudinski2010}.
%DIF > In a study with pulse-labelled $^{13}$C-CO$_2$, \citet{Hirte2018} found that the proportion of rhizodeposition C of belowground inputs increased with soil depth for maize and wheat. Thus, rhizodeposition remains to be one of the most difficult C input sources to quantify, with a wide range of estimates that also depends on plant species/cultivars and growth stages \citep[e.g.][]{Amos2006, Pausch2018}.


\DIFaddbegin \subsection{\DIFadd{Depth dependence of decomposition and microbial activity}}
%DIF > The chemical properties of soils change along the vertical profile \citep{Rumpel2011, Vancampenhout2012}. Most well-known are the decrease of
%DIF > C/N ratio with depth, and the enrichment of $^{13}$C and $^{15}$N \citep{Ehleringer2000, Nadelhoffer1988, Hogberg1997, Paul2020}. These gradients indicate a change from plant derived
%DIF > to more decomposed and microbial derived organic matter with depth \citep{Rumpel2002, Rumpel2011, Baisden2002}. It has been suggested that microbial residues are more effectively stabilized by organo-mineral interactions, which have been found to be an important mechanism in the deep soil
%DIF > \citep{Rumpel2012}.

\DIFaddend A distinct property of most soils is the decrease of radiocarbon ($^{14}$C) activity with
depth, indicating a higher average age of carbon since plant uptake from the atmosphere \DIFdelbegin \DIFdel{.
Near the surface, average radiocarbon age is typically in the range of 1 to 100 yr,
whereas in the deep soil ages of 10 000 yr or more are no exception \mbox{%DIFAUXCMD
\citep{Mathieu2015, He2016, Lawrence2020, Rumpel2011}}\hskip0pt%DIFAUXCMD
. Presumably, }\DIFdelend \DIFaddbegin \DIFadd{and a decrease in decomposition rates with depth \mbox{%DIFAUXCMD
\citep{Mathieu2015, He2016, Lawrence2020, Rumpel2011, Heckman2022, Scheibe2023, HicksPries2023}}\hskip0pt%DIFAUXCMD
. Potential factors responsible for }\DIFaddend this age gradient \DIFdelbegin \DIFdel{is partially explained by }\DIFdelend \DIFaddbegin \DIFadd{include
 \mbox{%DIFAUXCMD
\citep[c.f.][]{Ahrens2020}}\hskip0pt%DIFAUXCMD
:  the }\DIFaddend slow
downward transport of carbon fractions that are either very recalcitrant, or recurrently recycled by microbes \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Elzein1995, Kaiser2012}}\hskip0pt%DIFAUXCMD
.
However, a more important cause may be decreasing average decomposition rates }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Elzein1995, Gleixner2013, Kaiser2012, Roth2019}}\hskip0pt%DIFAUXCMD
;
decreasing microbial activity }\DIFaddend along
the profile \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Jenkinson2008, Koven2013BGS, Persson2000}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Jenkinson2008, Persson2000, Koven2013BGS, Wang2021}}\hskip0pt%DIFAUXCMD
, and increasing role of organo-mineral associations with depth \mbox{%DIFAUXCMD
\citep{Rumpel2011, Eusterhues2003, Rasmussen2018, Cotrufo2022, Georgiou2022, HicksPries2023}}\hskip0pt%DIFAUXCMD
}\DIFaddend . The reason for this gradient is not fully understood
yet and needs further exploration \citep{Guo2023}. It may be caused by the selective preservation of recalcitrant compounds combined with downward transport \citep{Elzein1995, Luo2020} \DIFdelbegin \DIFdel{or }\DIFdelend \DIFaddbegin \DIFadd{as well as }\DIFaddend nonlinear interactions among C fractions \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Guenet2013, Liang2018}}\hskip0pt%DIFAUXCMD
. 
Also, the dominant
source of organic matter in deep soils is root input, which is chemically more recalcitrant than aboveground litter \mbox{%DIFAUXCMD
\citep{Rasse2005}}\hskip0pt%DIFAUXCMD
.
}\DIFdelend \DIFaddbegin \DIFadd{such as priming \mbox{%DIFAUXCMD
\citep{Guenet2013, Liang2018, Wang2021}}\hskip0pt%DIFAUXCMD
. 
%DIF > Also, the dominant
%DIF > source of organic matter in deep soils is root input, which is chemically more recalcitrant than aboveground litter \citep{Rasse2005}.
}\DIFaddend 

\DIFdelbegin \DIFdel{Another cause of the decreasing decomposition rates with depth is the increased occurrence of certain stabilization mechanisms. Several studies have found that organic
matter in subsoils is predominantly associated with minerals \mbox{%DIFAUXCMD
\citep{Rumpel2011, Eusterhues2003} }\hskip0pt%DIFAUXCMD
\mbox{%DIFAUXCMD
\citep{Rasmussen2018} }\hskip0pt%DIFAUXCMD
or occluded within aggregates \mbox{%DIFAUXCMD
\citep{Moni2010}}\hskip0pt%DIFAUXCMD
. }\DIFdelend %DIF > Another cause of the decreasing decomposition rates with depth is the increased occurrence of certain stabilization mechanisms. Several studies have found that organic
%DIF > matter in subsoils is predominantly associated with minerals \citep{Rumpel2011, Eusterhues2003, Rasmussen2018} or occluded within aggregates \citep{Moni2010}. 
A further cause of stabilization in deep soil is physical disconnection between microbes and substrates \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Don2013}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Don2013, Gleixner2013}}\hskip0pt%DIFAUXCMD
}\DIFaddend . Most microbial activity in deep soils is located in
...
\DIFdelbegin \DIFdel{More literature exists on modelling of benthic bioturbation and its effects on chemical species in sediments at the bottom of oceans and lakes \mbox{%DIFAUXCMD
\citep[e.g.][]{Boudreau1986b, Meysman2005, Meysman2010, Sarmiento2006, Arndt2013}}\hskip0pt%DIFAUXCMD
. Bioturbation is usually modeled as a diffusive process, although it has been shown that this approach is not generally valid \mbox{%DIFAUXCMD
\citep{Meysman2003, Meysman2010}}\hskip0pt%DIFAUXCMD
. Alternatively, other schemes have been proposed to represent diffusive processes, which includes both deterministic \mbox{%DIFAUXCMD
\citep{Boudreau1986a, Boudreau1989} }\hskip0pt%DIFAUXCMD
and stochastic approaches \mbox{%DIFAUXCMD
\citep{Bunzl2002, Choi2002, Meysman2008}}\hskip0pt%DIFAUXCMD
.
}\DIFdelend %DIF > More literature exists on modelling of benthic bioturbation and its effects on chemical species in sediments at the bottom of oceans and lakes \citep[e.g.][]{Boudreau1986b, Meysman2005, Meysman2010, Sarmiento2006, Arndt2013}. Bioturbation in these systems is usually modeled as a diffusive process, although it has been shown that this approach is not generally valid \citep{Meysman2003, Meysman2010}. Alternatively, other schemes have been proposed to represent diffusive processes, which includes both deterministic \citep{Boudreau1986a, Boudreau1989} and stochastic approaches \citep{Bunzl2002, Choi2002, Meysman2008}.
...
explain measurements of carbon and tracer profiles. Increasingly, more models are now developed to represent soil carbon cycling and predict land-atmosphere carbon exchange \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Jenkinson2008,Huang2018, Koven2013BGS, Ahrens2020, Luo2020}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Huang2018, Koven2013BGS, Tifafi2018, Ahrens2020, Luo2020, Wang2021, Tao2023}}\hskip0pt%DIFAUXCMD
, and the effect of land management practices on carbon sequestration in soils \mbox{%DIFAUXCMD
\citep{Jenkinson2008, Taghizadeh2014, Keyvanshokouhi2019, Mary2020}}\hskip0pt%DIFAUXCMD
}\DIFaddend .
...
Models explicitly representing decomposition usually use one or three pools to represent decomposition as in most traditional \DIFdelbegin \DIFdel{first order pool }\DIFdelend models. More detailed representations of decomposition are presented in the model of \citet{Braakhekke2011, Braakhekke2013}, which represents five different pools, including a litter layer component clearly separating processes related to decomposition in the surface organic layer from processes more affected by vertical transport in the mineral horizons. Also, the model of \citet{Koven2013BGS} used 7 distinct C pools: coarse woody debris, three litter pools, and \DIFdelbegin \DIFdel{three }\DIFdelend \DIFaddbegin \DIFadd{3 }\DIFaddend mineral soil C pools. 

In the COMISSION model, not only advective DOC transport is considered, but also advective transport of litter particles similarly as in sediment models \citep{Ahrens2015, Ahrens2020}. In the latest version of the model \citep{Ahrens2020}, advective litter transfer and particle diffusion are depth dependent. The model also \DIFdelbegin \DIFdel{consider }\DIFdelend \DIFaddbegin \DIFadd{considers }\DIFaddend non-linear interactions among C pools, therefore it deviates from the constant linear coefficients model of equation \ref{eq:linearSecondOrder} and is in better analogy to equation \ref{eq:generalTransport}. \DIFaddbegin \DIFadd{Similarly, the models of \mbox{%DIFAUXCMD
\citet{Wang2021} }\hskip0pt%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citet{Tao2023} }\hskip0pt%DIFAUXCMD
include nonlinear interactions among C pools, with the size of the microbial biomass pools interacting with the size of litter and mineral soil pools, but ignoring advection and treating diffusion as a constant across all depths.  
}\DIFaddend 

\begin{landscape}
\begin{table}[h]
   \centering \tiny
   \caption{Summary of models representing C dynamics along the vertical profile using the \DIFdelbeginFL \DIFdelFL{advection-diffusion-reaction }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{diffusion-advection-reaction (DAR) }\DIFaddendFL paradigm. \DIFaddbeginFL \DIFaddFL{Column on processes indicates the combination of diffusion (D), advection (A), and reaction/decomposition (R) included in the models together with the main equation that generalizes the model. }\DIFaddendFL Modified and updated from \citet{Koven2013BGS}.} \small
   \begin{tabular}{@{} lccccccr @{}} % Column formatting, @{} suppresses leading/trailing space
      \toprule
      Model/reference    & \DIFdelbeginFL \DIFdelFL{Mathematical form }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Processes }\DIFaddendFL & $d_{\mathrm{max}}$ (m) & Ecosystem/location & $n$ & $v$ & $\kappa$ & P\'eclet number\\
      \midrule
      \citet{OBrien1978} & \DIFaddbeginFL \DIFaddFL{DR, }\DIFaddendFL Eq. \ref{eq:linearDiffusion} & 1.00 & Managed pasture, NZ & 1 & & 13.2 cm$^2$ yr$^{-1}$ & 0 \\
      \citet{Elzein1995}   & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder} & 1.65 & Kattinkar, India & 3 & 0.13 mm yr$^{-1}$ & 5.15  cm$^2$ yr$^{-1}$ & 0.003 \\
      \citet{Elzein1995}   & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder} & 1.95 & Par\'a, Brazil  & 3 & 0.34 mm yr$^{-1}$ & 16.58  cm$^2$ yr$^{-1}$  & 0.002 \\
      \citet{Elzein1995}   & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder} & 1.63 & Bahia, Brazil & 3 & 0.48 mm yr$^{-1}$ & 5.29  cm$^2$ yr$^{-1}$ & 0.009 \\
      \citet{Elzein1995}   & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder} & 0.52 & Forest, Bezange, France & 3 & 0.6 mm yr$^{-1}$ & 0.94  cm$^2$ yr$^{-1}$ & 0.064 \\
      \citet{Elzein1995}   & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder} & 1.00 & Forest, Marly, France & 3 & 0.42 mm yr$^{-1}$ & 1.48  cm$^2$ yr$^{-1}$ & 0.028 \\
      \citet{Feng1999}  & \DIFaddbeginFL \DIFaddFL{AR, }\DIFaddendFL Eq. \ref{eq:linearAdvection}  & 1.00 & Oak chaparral, USA & 1 & 1.51 cm yr$^{-1}$ & & $\infty$ \\
...
& \DIFaddbeginFL \DIFaddFL{AR, }\DIFaddendFL Eq. \ref{eq:linearAdvection}  & & $< 3$ ky old grassland soil, USA & 3 & [4.0, 0.47, 0.40] mm yr$^{-1}$ & & $\infty$ \\
      ...
      \citet{Braakhekke2011} & \DIFaddbeginFL \DIFaddFL{DAR, }\DIFaddendFL Eq. \ref{eq:linearSecondOrder}  & 0.7 & Deciduous forest, Germany & 5 & 0.002 m yr$^{-1}$ & 0.6 cm$^{2}$ yr$^{-1}$ \\ %\tablefootnote{Assuming a bulk density of 1000 kg cm$^{-3}$} & 0.333 \\
      \DIFaddbeginFL \DIFaddFL{\mbox{%DIFAUXCMD
\citet{Ota2013} }\hskip0pt%DIFAUXCMD
...
To investigate the effect of diffusion and advection, we ran simulations with values of $\kappa = \{0.1, 1, 5, 15\}$ cm$^2$ yr$^{-1}$ and $v = \{0.1, 1, 5, 10 \}$ cm yr$^{-1}$  (Figure \ref{fig:AdvectionDiffusion})\DIFaddbegin \DIFadd{, with root inputs and decomposition following equations \ref{eq:ud} and \ref{eq:kd} as described below}\DIFaddend . The results show that vertical transport processes tend to create a horizon with largest rate of change in concentrations of C with depth (1st derivative) close to the surface. This layer could be the result of either advection or diffusion (Figure \ref{fig:AdvectionDiffusion}). Because in these simulations, lateral root inputs and decomposition decrease with depth (see \DIFaddbegin \DIFadd{equations \ref{eq:ud}, and \ref{eq:kd} }\DIFaddend below), there is a general trend of C concentrations to decline to values close to zero. Therefore, vertical transport do not seem to play a major role in transporting carbon below 50 cm depth within the range of advection and diffusion values used in these simulations\DIFaddbegin \DIFadd{, which covers the entire range of values obtained in previous studies (Table \ref{tab:Models})}\DIFaddend . Only at high advection velocities ($v=10$ cm yr$^{-1}$) some carbon is transported below 50 cm depth, but this advection velocity is much higher than what has been used before in other models (Table \ref{tab:Models}).
...
\end{equation}
with the maximum decomposition rate at the surface given by $k_0 = k(d=0)$, and $d_e$ representing the e-folding depth of decomposition rates. In our simulations, we used values of $k_0 : \{1, 0.1, 0.01 \}$ yr$^{-1}$ and a constant value of $d_e = 90$ cm (the model showed little sensitivity to different values of $d_e$). \DIFaddbegin \DIFadd{Equation \ref{eq:kd} is an empirical function that accounts for unresolved processes such as changes in oxygen availability or microbial activity with depth, and therefore it could be considered as a place holder for other mechanistic representations of depth dependent microbial dynamics. 
}\DIFaddend 

The results from this second set of simulations evaluating the effect of lateral root inputs and decomposition showed that slowing down decomposition can have a significant effect on the shape of the vertical soil C profile \DIFaddbegin \DIFadd{(Figure \ref{fig:rootDecomp})}\DIFaddend . These results \DIFdelbegin \DIFdel{seems }\DIFdelend \DIFaddbegin \DIFadd{seem }\DIFaddend counterintuitive because equation \ref{eq:simpleCase} suggest that the negative term of the equation should be affected by larger values of $k(d)$, but because with slow decomposition higher amounts of C are obtained at steady-state, the entire term $k(d) x(d)$ is large, promoting a strong soil C gradient. The vertical distribution of root inputs has also a significant effect on the shape of the soil C profile, with shallow root inputs promoting a strong vertical gradient and deep rooting systems a more pronounced gradient with lower values of the first derivative \DIFaddbegin \DIFadd{(Figure \ref{fig:rootDecomp})}\DIFaddend . In this set of simulations, we observed also a maximum rate of change of C at the upper layers where the value of the first derivative reached a maximum. 
...
\begin{equation}
\DIFdelbegin %DIFDELCMD < \bm{M}%%%
\DIFdelend \DIFaddbegin \bm{m}\DIFaddend (t) = e^{\tau \mathbf{B}} \ \bm{u},
\end{equation}
where \DIFdelbegin \DIFdel{$\bm{M}(t)$ }\DIFdelend \DIFaddbegin \DIFadd{$\bm{m}(t)$ }\DIFaddend is a vector with the mass remaining for each compartment. This mass remaining is related to the transit time of carbon, which is defined as the time it takes carbon atoms to pass through the entire network of compartments until C leaves the soil system \citep{Bolin1973, Manzoni2009JGR, Sierra2018JAMES}. \DIFdelbegin \DIFdel{It }\DIFdelend \DIFaddbegin \DIFadd{The transit time distribution of carbon }\DIFaddend can be expressed as \citep{Metzler2018MG}
\begin{equation} \label{eq:transitTime}
f_T(\tau) = -\bm{1}^{\top} \ \mathbf{B} \ e^{\tau \mathbf{B}} \frac{\bm{u}}{\Vert \bm{u} \Vert}\DIFaddbegin \DIFadd{,
}\DIFaddend \end{equation}
\DIFaddbegin \DIFadd{and represents the relative proportion of carbon leaving the system at a time $\tau$. In soils, transit time distributions generally have a long tail, indicating that most carbon entering soils are respired quickly but small proportions can stay for long times \mbox{%DIFAUXCMD
\citep{Sierra2018GBC}}\hskip0pt%DIFAUXCMD
. 
}\DIFaddend 


Carbon Sequestration (CS) \DIFaddbegin \DIFadd{is the storage of a certain amount of carbon over a certain period of time. It }\DIFaddend evaluates the fate of new inputs entering the soil integrated over a \DIFdelbegin \DIFdel{period of time }\DIFdelend \DIFaddbegin \DIFadd{time horizon}\DIFaddend . The amount of sequestration quantified by the CS metric depends on both the amount of inputs entering the soil and the time it takes this carbon to return to the atmosphere in the form of respiration. This amount of time is proportional to the transit time of carbon. 


%\subsection{The transit time distribution as a tool to assess C sequestration}
For a compartmental system at equilibrium, CS can be obtained as \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Sierra2021BGS}
}\hskip0pt%DIFAUXCMD
...
Using data from ISRaD and a dataset on root input profiles, \citet{Xiao2022} obtained estimates of mean ages and mean transit times for soil C profiles at the global scale. The global averages revealed that mean transit times of C are always younger than the mean age of C stored at all soil depths (Figure \ref{fig:AgeTTprofiles}). In other words, despite the C stored in the soil being hundreds to thousands of years old, the C respired is only a few years to decades old. This result is consistent with our transit time simulations that showed mean transit times of only a few years (Figure \ref{fig:transitTime}, Table \ref{tab:simulationSetup}). However, the actual values of mean transit time obtained from the data are actually much higher than those from the model results. This is to be expected given that the model used for the example only considered one single pool \DIFaddbegin \DIFadd{with a relatively fast decomposition rate}\DIFaddend , but in reality soil carbon is highly heterogeneous and a significant proportion of its total carbon cycles at much slower rates, which would contribute to \DIFdelbegin \DIFdel{higher }\DIFdelend \DIFaddbegin \DIFadd{longer }\DIFaddend transit times.  In addition, sorption of OM to mineral surfaces may increase with depth, making the overall decomposition of C at depth more limited \citep{Ahrens2020}. Nevertheless, model simulations and observations agree in that new C inputs to soil only remain stored in timescales of years to decades. 

Fast mean transit times were observed for tropical forest, grassland and cropland soils, while long transit times in the order of decades to centuries were only observed for tundra and boreal forest soils (Figure \ref{fig:AgeTTprofiles}). These results are consistent with the idea that low temperatures and energy limitation may play a significant role in controlling the transit time of C at the biome level \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{Lu2018, Xiao2022}}\hskip0pt%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{Lu2018, Xiao2022, Sierra2023PTRS}}\hskip0pt%DIFAUXCMD
}\DIFaddend , with fast transit times in warm regions and longer transit times in cold high-latitude regions.
...
\DIFaddbegin \section{\DIFadd{Implications for soil C management}}
\DIFadd{Our analysis of a general model of soil C profile formation, together with the analysis of observations of soil carbon concentrations and transit times, provide relevant insights that can inform land management for carbon sequestration and climate change mitigation. 
...
%DIF > Data on C concentrations and their change with depth in global soil profiles (Figures \ref{fig:Cprofiles} and \ref{fig:Derivatives}) show that C stocks decline strongly with depth for most soils. 
\DIFadd{If soils would be managed to increase subsoil C storage, the change of C concentrations with depth should be less dramatic and change less with respect to topsoil (Figure \ref{fig:managementObjective}). From equation \ref{eq:firstDeriv}, it can be inferred that a management objective could be framed in terms of keeping the first derivative of C concentration with respect to depth close to zero, so the storage of carbon in subsoil remains relatively similar to levels in topsoil. Using the model of constant advection and diffusion coefficients at steady-state (equation \ref{eq:firstDeriv}), we can frame this management objective as 
}\begin{equation}
\DIFadd{\frac{\partial x(d)}{\partial d} = \frac{\kappa}{v} \frac{\partial^2 x(d)}{\partial^2 d} + \frac{g(d)}{v} = 0,
}\end{equation} 
\DIFadd{and because the derivative of a constant value of zero is equals to zero, the second derivative term vanishes from this equation and the management objective reduces to
}\begin{equation} \DIFadd{\label{eq:objective}
 \frac{g(d)}{v} = 0.
}\end{equation} 
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=\textwidth]{Figures/managementObjective.pdf} %DIF >  requires the graphicx package
   \caption{\DIFaddFL{Graphical example for defining a management objective to increase C storage in the subsoil. By decreasing the ratio $g(d)/v$ as close to zero as possible, the decrease of C concentration with depth is less steep and more carbon can be stored in the subsoil. For this example, advection velocity was increased from 1 to 100 cm yr$^{1}$.}}
   \label{fig:managementObjective}
\end{figure}

\DIFadd{This equation suggest that an effective way to achieve the goal of increasing C storage in the subsoil would be through increasing advective transport of C from top to subsoil; i.e. increasing values of $v$ so the ratio of equation \ref{eq:objective} approaches zero (Figure \ref{fig:managementObjective}). Provided C inputs are high, their vertical advective movement should contribute to increase total carbon storage. In other words, even though vertical C transfer does not seem to play a significant role in explaining current data on soil C profiles, management activities could be implemented to increase vertical C transfers to horizons where it can be stabilized on available mineral surfaces \mbox{%DIFAUXCMD
\citep[cf.][]{Ahrens2020, Georgiou2022} }\hskip0pt%DIFAUXCMD
and protect it from decomposition. Equation \ref{eq:firstDeriv} also suggest that a small difference between C inputs and decomposition across all depths ($g(d) \approx 0$) helps to decrease the gradient of C decline with depth. For example, exogenous amendments of organic matter with low decomposition rates could help to reduce this difference and reduce C decline with depth. There may be many other ways to achieve this management goal, and a challenge for future research would be to test this theoretical prediction through innovative experiments.
}

\DIFadd{Equation \ref{eq:objective} also suggests that changes in particle diffusion have little or no effect in contributing to increase carbon storage in the subsoil. This may imply that the diffusive mixing of carbon due to tillage plays no relevant role for increasing carbon in the entire profile. 
}
...
\begin{enumerate*}
\item The main processes that contribute to the formation of soil C profiles are root productivity and rhizodeposition, microbial decomposition, advective processes such as liquid phase transport, and diffusive processes such as bioturbation\DIFdelbegin \DIFdel{and cryoturbation}\DIFdelend \DIFaddbegin \DIFadd{, cryoturbation, and tillage}\DIFaddend . 
\item These processes can be expressed in models under the general paradigm of the \DIFdelbegin \DIFdel{advection-diffusion-reaction }\DIFdelend \DIFaddbegin \DIFadd{diffusion-advection-reaction }\DIFaddend equation, with most previously proposed models being a special case of this general paradigm. 
...
\item The transit time of C is only a few years to decades in most soils, which implies that promoting the addition of new C inputs to soils would only contribute to climate change mitigation in \DIFdelbegin \DIFdel{the short term (}\DIFdelend \DIFaddbegin \DIFadd{timescales of }\DIFaddend years to decades\DIFdelbegin \DIFdel{)}\DIFdelend . Carbon sequestration at longer timescales is only possible in slow cycling systems such as tundra and boreal forest soils, but primary production is relatively low in these regions\DIFaddbegin \DIFadd{.
}\item \DIFadd{Increasing C storage in the subsoil could be achieved by increasing rates of vertical transport through advective processes, or by reducing the difference between plant inputs and decomposition at all depths. Innovative experiments and management practices are needed to test this prediction based on current theoretical understanding of carbon dynamics in the subsoil}\DIFaddend . 
\end{enumerate*}
